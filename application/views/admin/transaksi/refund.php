...
<h3 class="title">Refund Dana <?= $master['id_order'] ?></h3>
<br>
<br>
<div class="card">
      <?php if ($validation == 0) { ?>
            <div class="card-body">
                  <h6 class="card-header">User Belum Memiliki Rekening, <a href="<?= base_url() ?>admin/pending_bayar">Pending Pembayaran</a></h6>
            </div>
      <?php } else { ?>
            <form action="<?= base_url(); ?>admin/bayar_retur" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                        <div class="form-row">
